...
\newcommand{\myTitle}{Virtual Cue\xspace}
\newcommand{\mySubtitle}{A new Way in waiting in Line\xspace}
\newcommand{\myDegree}{Ingenieur)\xspace}
...
\areaset[current]{452pt}{761pt} % 686 (factor 2.2) + 33 head + 42 head \the\footskip
