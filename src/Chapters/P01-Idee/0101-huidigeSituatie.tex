...
\chapter{Huidige situatie}\label{ch:huidige-situatie} % Chapter title

Het is een mooie zomer dag een gezin heeft het plan om naar een pretpark te gaan, Vader Tim en Moeder Suzan pakken de auto in met broodjes en drinken voor de dag.
Zoon Bas en Dochter Lianne lopen al de hele ochtend springend door het huis.
Iedereen wordt in de auto gepakt en de dag kan beginnen.

saaie bezigheid die men kan doen in een pretpark.
