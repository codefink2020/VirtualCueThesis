...
% Inleiding
\include{Chapters/P00-Inleiding/0000-Inleiding}

\ctparttext{ Deel 1 gaat voornamelijk over het idee, en hoe deze de huidige situatie naar de nieuwe situatie transfromeert.}

\part{Idee} % First part of the thesis

\include{Chapters/P01-Idee/0101-huidigeSituatie} % Chapter 1
\include{Chapters/P01-Idee/0102-Idee}
\include{Chapters/P01-Idee/0103-VoorspeldeSituatie}
